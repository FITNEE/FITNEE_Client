    ...
    >
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <>
              <Tab_Home style={{ color: focused ? colors.l_main : colors.grey_5 }} width={24} height={24} />
              <IconText
                style={{
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <>
              <Tab_MyRoutine style={{ color: focused ? colors.l_main : colors.grey_5 }} width={24} height={24} />
              <IconText
                style={{
                  fontFamily: 'Pretendard-Medium',
                  color: focused ? colors.l_main : colors.grey_7,
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <>
              <Tab_Exercise style={{ color: focused ? colors.l_main : colors.grey_5 }} width={24} height={24} />
              <IconText
                style={{
                  fontFamily: 'Pretendard-Medium',
                  color: focused ? colors.l_main : colors.grey_7,
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <>
              <Tab_ExerciseDict style={{ color: focused ? colors.l_main : colors.grey_5 }} width={24} height={24} />
              <IconText
                style={{
                  fontFamily: 'Pretendard-Medium',
                  color: focused ? colors.l_main : colors.grey_7,
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused, color, size }) => (
            <>
              <Tab_MyPage style={{ color: focused ? colors.l_main : colors.grey_5 }} width={24} height={24} />
