...
export const MovableSchedule = ({ id, isDark, positions, routineId, SCHEDULE, setNewSCHE }) => {
    ...
    const gestureHandler = useAnimatedGestureHandler({
        ...
        onActive(event) {
            ...
            const newPosition = clamp(Math.floor(positionX / SCHEDULE_W), 0, SCHEDULE.length - 1)
