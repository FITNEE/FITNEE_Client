...
export default function Dictionary_3({ navigation, route }) {
  ...
  const pressShareBtn = async () => {
    try {
      const result = await Share.share({
        message: `Fitnee에서 ${exerciseInfo.name} 정보를 확인해보세요!`,
      });
  ...
  return (
    <TouchableWithoutFeedback onPressIn={() => setBubbleBool(false)}>
          ...
          >
            <DictionaryContainer>
              <TitleContainer>
                <NameContainer>
                  <AreaText>
                    {exerciseInfo.parts} | {exerciseInfo.muscle} |{" "}
              ...
              <TabContainer>
                <LeftTab
                  ...
                  style={
                    leftTabActivate
                      ? {
                          borderBottomColor: `${
                            isDark ? colors.d_main : colors.l_main
                          }`,
                        }
                      : null
                  }
                ...
                >
                  <TabText style={leftTabActivate ? { fontWeight: 600 } : null}>
                    운동 방법
                  </TabText>
                </LeftTab>
                <RightTab
                ...
                >
                  <TabText style={leftTabActivate ? null : { fontWeight: 600 }}>
                    채팅 42개
                  </TabText>
