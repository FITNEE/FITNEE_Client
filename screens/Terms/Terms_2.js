    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.grey_1 }}>
      ...
      <Container contentContainerStyle={{ alignItems: 'center' }}>
        <ContentContainer>
          ...
          <SubContent>{`< Fitnee >('https://fitnee.co.kr'이하 'Fitnee')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
계정 삭제나 개인정보 수정 요청은 소속 앱 또는 서비스 내 설정 메뉴에서 직접 처리할 수 있습니다.`}</SubContent>
        </ContentContainer>
      </Container>
    </SafeAreaView>
  )
